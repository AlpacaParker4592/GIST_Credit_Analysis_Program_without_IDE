...
### 프로그램 이용 관련
* 해당 프로그램은 **귀하의 졸업을 보장하지 않습니다.** 어디까지나 참고용으로만 사용하시길 바랍니다. 
...
* 이 프로그램은 귀하의 졸업 요건을 그래프로 나타내기 쉽도록 졸업 요건 일부를 수정했으며, 귀하께서 수강(이수)한 교과목을 전체적으로 출력하지 않습니다.
정확한 졸업 요건을 알거나 지금까지 이수한 교과목 전체를 보고자 하는 경우에는 다음 프로그램을 사용하시길 바랍니다.
